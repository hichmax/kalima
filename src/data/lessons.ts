...
export const alphabetLetters = [
  { arabic: "ا", name: "alif", sound: "ā / support de hamza", spokenArabic: "أَلِف، أَ", audioSrc: "/audio/alphabet/01-alif.wav" },
  { arabic: "ب", name: "bāʾ", sound: "b", spokenArabic: "بَاء، بَ", audioSrc: "/audio/alphabet/02-baa.wav" },
  { arabic: "ت", name: "tāʾ", sound: "t", spokenArabic: "تَاء، تَ", audioSrc: "/audio/alphabet/03-taa.wav" },
  { arabic: "ث", name: "thāʾ", sound: "th", spokenArabic: "ثَاء، ثَ", audioSrc: "/audio/alphabet/04-thaa.wav" },
  { arabic: "ج", name: "jīm", sound: "j", spokenArabic: "جِيم، جَ", audioSrc: "/audio/alphabet/05-jiim.wav" },
  { arabic: "ح", name: "ḥāʾ", sound: "ḥ", spokenArabic: "حَاء، حَ", audioSrc: "/audio/alphabet/06-haa-emphatic.wav" },
  { arabic: "خ", name: "khāʾ", sound: "kh", spokenArabic: "خَاء، خَ", audioSrc: "/audio/alphabet/07-khaa.wav" },
  { arabic: "د", name: "dāl", sound: "d", spokenArabic: "دَال، دَ", audioSrc: "/audio/alphabet/08-daal.wav" },
  { arabic: "ذ", name: "dhāl", sound: "dh", spokenArabic: "ذَال، ذَ", audioSrc: "/audio/alphabet/09-dhaal.wav" },
  { arabic: "ر", name: "rāʾ", sound: "r", spokenArabic: "رَاء، رَ", audioSrc: "/audio/alphabet/10-raa.wav" },
  { arabic: "ز", name: "zāy", sound: "z", spokenArabic: "زَاي، زَ", audioSrc: "/audio/alphabet/11-zay.wav" },
  { arabic: "س", name: "sīn", sound: "s", spokenArabic: "سِين، سَ", audioSrc: "/audio/alphabet/12-siin.wav" },
  { arabic: "ش", name: "shīn", sound: "sh", spokenArabic: "شِين، شَ", audioSrc: "/audio/alphabet/13-shiin.wav" },
  { arabic: "ص", name: "ṣād", sound: "ṣ", spokenArabic: "صَاد، صَ", audioSrc: "/audio/alphabet/14-saad.wav" },
  { arabic: "ض", name: "ḍād", sound: "ḍ", spokenArabic: "ضَاد، ضَ", audioSrc: "/audio/alphabet/15-daad.wav" },
  { arabic: "ط", name: "ṭāʾ", sound: "ṭ", spokenArabic: "طَاء، طَ", audioSrc: "/audio/alphabet/16-taa-emphatic.wav" },
  { arabic: "ظ", name: "ẓāʾ", sound: "ẓ", spokenArabic: "ظَاء، ظَ", audioSrc: "/audio/alphabet/17-zaa-emphatic.wav" },
  { arabic: "ع", name: "ʿayn", sound: "ʿ", spokenArabic: "عَيْن، عَ", audioSrc: "/audio/alphabet/18-ayn.wav" },
  { arabic: "غ", name: "ghayn", sound: "gh", spokenArabic: "غَيْن، غَ", audioSrc: "/audio/alphabet/19-ghayn.wav" },
  { arabic: "ف", name: "fāʾ", sound: "f", spokenArabic: "فَاء، فَ", audioSrc: "/audio/alphabet/20-faa.wav" },
  { arabic: "ق", name: "qāf", sound: "q", spokenArabic: "قَاف، قَ", audioSrc: "/audio/alphabet/21-qaaf.wav" },
  { arabic: "ك", name: "kāf", sound: "k", spokenArabic: "كَاف، كَ", audioSrc: "/audio/alphabet/22-kaaf.wav" },
  { arabic: "ل", name: "lām", sound: "l", spokenArabic: "لَام، لَ", audioSrc: "/audio/alphabet/23-laam.wav" },
  { arabic: "م", name: "mīm", sound: "m", spokenArabic: "مِيم، مَ", audioSrc: "/audio/alphabet/24-miim.wav" },
  { arabic: "ن", name: "nūn", sound: "n", spokenArabic: "نُون، نَ", audioSrc: "/audio/alphabet/25-nuun.wav" },
  { arabic: "ه", name: "hāʾ", sound: "h", spokenArabic: "هَاء، هَ", audioSrc: "/audio/alphabet/26-haa.wav" },
  { arabic: "و", name: "wāw", sound: "w / ū", spokenArabic: "وَاو، وَ", audioSrc: "/audio/alphabet/27-waaw.wav" },
  { arabic: "ي", name: "yāʾ", sound: "y / ī", spokenArabic: "يَاء، يَ", audioSrc: "/audio/alphabet/28-yaa.wav" },
] as const;
...
export const beginnerLessons: BeginnerLessonData[] = [
  {
    ...
    quiz: {
      question: "Quelle forme correspond au nom « bāʾ » ?",
      options: ["ت", "ب", "ث"],
      correctIndex: 1,
      success: "Exact : ب est la forme du bāʾ.",
      retry: "Écoute de nouveau bāʾ puis observe la lettre qui porte un point dessous.",
    },
    duration: 10,
  ...
  },
  {
    ...
    quiz: {
      question: "Quelle forme correspond au nom « tāʾ » ?",
      options: ["ب", "ث", "ت"],
      correctIndex: 2,
      success: "Exact : ت est la forme du tāʾ.",
      retry: "Cherche la forme qui porte deux points au-dessus.",
    },
    duration: 8,
    sourceIds: unicodeSources,
    audioReference: "1:1:1",
